...
export const canonicalRoutes: RouteDefinition[] = [
  ...
  canonical('/productos/seguros-salud/seguros-asisa', { locale: 'es', canonical: '/productos/seguros-salud/seguros-asisa', alternate: '/en/health-insurance/asisa-insurance', indexable: true, prerender: true, sitemap: true }),
  canonical('/en/health-insurance/asisa-insurance', { locale: 'en', canonical: '/en/health-insurance/asisa-insurance', alternate: '/productos/seguros-salud/seguros-asisa', indexable: true, prerender: true, sitemap: true }),
  canonical('/productos/seguros-salud/seguros-asisa/asisa-health-students', { locale: 'es', canonical: '/productos/seguros-salud/seguros-asisa/asisa-health-students', alternate: '/en/health-insurance/asisa-health-students', indexable: true, prerender: true, sitemap: true }),
  canonical('/en/health-insurance/asisa-health-students', { locale: 'en', canonical: '/en/health-insurance/asisa-health-students', alternate: '/productos/seguros-salud/seguros-asisa/asisa-health-students', indexable: true, prerender: true, sitemap: true }),
  canonical('/productos/seguros-salud/seguros-asisa/asisa-health-residents', { locale: 'es', canonical: '/productos/seguros-salud/seguros-asisa/asisa-health-residents', alternate: '/en/health-insurance/asisa-health-residents', indexable: true, prerender: true, sitemap: true }),
  canonical('/en/health-insurance/asisa-health-residents', { locale: 'en', canonical: '/en/health-insurance/asisa-health-residents', alternate: '/productos/seguros-salud/seguros-asisa/asisa-health-residents', indexable: true, prerender: true, sitemap: true }),
  canonical('/productos/seguros-salud/seguros-asisa/asisa-completa', { locale: 'es', canonical: '/productos/seguros-salud/seguros-asisa/asisa-completa', alternate: '/en/health-insurance/asisa-completa', indexable: true, prerender: true, sitemap: true }),
  canonical('/en/health-insurance/asisa-completa', { locale: 'en', canonical: '/en/health-insurance/asisa-completa', alternate: '/productos/seguros-salud/seguros-asisa/asisa-completa', indexable: true, prerender: true, sitemap: true }),
  canonical('/productos/seguros-salud/seguros-asisa/asisa-esencial', { locale: 'es', canonical: '/productos/seguros-salud/seguros-asisa/asisa-esencial', alternate: '/en/health-insurance/asisa-esencial', indexable: true, prerender: true, sitemap: true }),
  canonical('/en/health-insurance/asisa-esencial', { locale: 'en', canonical: '/en/health-insurance/asisa-esencial', alternate: '/productos/seguros-salud/seguros-asisa/asisa-esencial', indexable: true, prerender: true, sitemap: true }),
