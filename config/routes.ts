...
export const canonicalRoutes: RouteDefinition[] = [
  ...
  canonical('/productos/seguros-salud/seguros-asisa', { locale: 'es', canonical: '/productos/seguros-salud/seguros-asisa', indexable: true, prerender: true, sitemap: true }),
  canonical('/productos/seguros-salud/seguros-asisa/asisa-health-students', { locale: 'es', canonical: '/productos/seguros-salud/seguros-asisa/asisa-health-students', indexable: true, prerender: true, sitemap: true }),
  canonical('/productos/seguros-salud/seguros-asisa/asisa-health-residents', { locale: 'es', canonical: '/productos/seguros-salud/seguros-asisa/asisa-health-residents', indexable: true, prerender: true, sitemap: true }),
  canonical('/productos/seguros-salud/seguros-asisa/asisa-completa', { locale: 'es', canonical: '/productos/seguros-salud/seguros-asisa/asisa-completa', indexable: true, prerender: true, sitemap: true }),
  canonical('/productos/seguros-salud/seguros-asisa/asisa-esencial', { locale: 'es', canonical: '/productos/seguros-salud/seguros-asisa/asisa-esencial', indexable: true, prerender: true, sitemap: true }),
