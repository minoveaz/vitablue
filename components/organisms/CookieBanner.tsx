...
export const CookieBanner: React.FC = () => {
  ...
  if (hasDecision && !isVisible) return null;

  return (
    <div
      className={`fixed bottom-6 left-4 right-4 md:left-auto md:right-8 md:max-w-md z-[300] transition-all duration-500 ease-out transform ${
        isVisible
        ...
        <div className="relative z-10 flex flex-col gap-6">
          <div className="flex items-start justify-between">
            ...
            <button 
              ...
              className="p-2 text-text-secondary hover:text-text-main transition-colors cursor-pointer"
