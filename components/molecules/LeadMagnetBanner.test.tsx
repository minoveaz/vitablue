...
describe('LeadMagnetBanner component', () => {
  it('renders inline banner correctly in Spanish with direct download link', () => {
  ...
  it('renders inline banner correctly in English with direct download link', () => {
  ...
  it('renders sidebar variant correctly with single direct download button', () => {
