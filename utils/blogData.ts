...
,
  {
    ...
    sections: [
      {
        type: 'paragraph',
        text: 'The Spanish Digital Nomad Visa (created under the pioneering <em>Startup Act / Ley de Startups 28/2022</em>) has positioned Spain as Europe\'s top destination for remote workers, tech professionals, and international freelancers. Whether applying at a Spanish Consulate in your home country (1-year visa) or directly within Spain before the <strong>Large Business and Strategic Collectives Unit (UGE-CE)</strong> for a 3-year residence permit, health insurance is one of the most rigorously examined legal requirements.'
      },
      {
        type: 'paragraph',
        text: 'Spanish immigration authorities will promptly issue a <em>Requerimiento de Subsanación</em> (formal notice of defect) if your insurance policy contains copays, deductibles, or reimbursement caps. In this official guide by <a href="/en" class="text-primary hover:underline font-bold">VitaBlue</a>, we detail the 4 mandatory conditions your private health insurance must meet to guarantee 100% approval.'
      },
      {
        type: 'heading-2',
        text: 'The 4 Mandatory Health Insurance Requirements for the Digital Nomad Visa'
      },
      {
        type: 'paragraph',
      ...
      },
      {
        type: 'list',
        items: [
          '<strong>Licensed Insurer in Spain (DGSFP)</strong>: The insurance company must be officially registered with the Directorate-General for Insurance (DGSFP) and operate directly within the Spanish healthcare framework (such as ASISA, Sanitas, or Adeslas).',
  ...
  },
  {
    ...
    title: 'How to Get the Official 24h Consular Health Insurance Certificate for Spain',
    category: 'tramites',
    ...
    excerpt: 'Discover how to obtain the official consular insurance certificate in English & Spanish required by BLS International and Spanish Consulates. Avoid visa rejection due to wrong clauses or travel insurance policies.',
    featuredImage: 'https://images.unsplash.com/photo-1450133064473-71024230f91b?q=80&w=800&auto=format&fit=crop',
    lang: 'en',
    sections: [
      {
        type: 'paragraph',
        text: 'When preparing your visa file for the Spanish Consulate or BLS International visa processing center, presenting a generic insurance receipt is the most common reason for consular delay. Consular officers specifically demand the <strong>Certificado Oficial de Cobertura para Visado y Extranjería</strong> (Official Certificate of Coverage for Visas and Immigration).'
      },
      {
        type: 'paragraph',
        text: 'This legal document, issued directly by the Spanish insurance provider, certifies in clear legal terms that your policy meets every requirement under Royal Decree 557/2011 and Organic Law 4/2000 on the rights and freedoms of foreigners in Spain.'
      },
      {
        type: 'heading-2',
        text: 'The 5 Essential Legal Clauses on the Certificate'
      },
      {
        type: 'list',
        items: [
          '<strong>Policy Identification</strong>: Full insured name, passport/NIE number, policy number, and exact period of validity matching your stay.',
          '<strong>Zero Copayment Clause</strong>: Explicit text stating: <em>"Póliza sin copagos ni franquicias a cargo del asegurado"</em>.',
          '<strong>No Waiting Periods</strong>: Affirmation that emergency, surgical, and diagnostic coverages are active without waiting periods (<em>"Sin periodos de carencia"</em>).',
          '<strong>Equivalent Public Healthcare Standard</strong>: Confirmation of comprehensive inpatient, outpatient, and specialty medical coverage across all Spanish autonomous communities.',
          '<strong>Repatriation Guarantee</strong>: Unlimited or €30,000+ coverage for medical evacuation and mortal remains repatriation.'
        ]
      },
      {
        type: 'heading-2',
        text: 'How to Obtain Your Certificate in 3 Simple Steps'
      },
      {
        type: 'paragraph',
        text: 'Through VitaBlue\'s digital portal, getting your official certificate takes less than 24 business hours:'
      },
      {
        type: 'list',
        items: [
          '<strong>1. Select Your Policy Online</strong>: Choose your preferred provider (ASISA, Sanitas, or Adeslas) with 0€ copays.',
          '<strong>2. Enter Visa Dates & Details</strong>: Set the policy start date to match your estimated arrival flight to Spain.',
          '<strong>3. Download Signed PDF Certificate</strong>: Receive your digitally signed and stamped certificate with a verification barcode ready for direct consular submission.'
        ]
      },
      {
        type: 'callout',
        text: '💡 <strong>Pro-Tip for Consulate Appointments</strong>: Print two physical copies of your certificate in color. Consular agents at BLS International will retain one original stamped copy for your official file.'
      }
    ]
  },
  {
  ...
  },
  {
    ...
    sections: [
      ...
      {
        type: 'callout',
        text: '💡 <strong>Retirement Planning Tip</strong>: If you are approaching age 64, contracting your policy before your 65th birthday unlocks standard lifetime renewal rights at significantly lower premium brackets.'
      }
    ]
  },
  {
    ...
    sections: [
      ...
      {
        type: 'callout',
        text: '👶 <strong>Newborn Baby Coverage</strong>: In Spain, all private maternity policies include complete medical care for the newborn during the first 30 days of life, allowing you to add your baby to the family policy seamlessly.'
      }
    ]
  }
