    ...
    <div className="w-full bg-slate-50/50 py-12 px-6 sm:px-8">
      ...
      <div className="max-w-3xl mx-auto bg-white rounded-[2rem] border border-slate-200/60 shadow-sm p-6 sm:p-8 lg:p-10 text-left space-y-6">
        <div className="flex items-center gap-3 text-primary pb-4 border-b border-slate-100">
          ...
          <h1 className="text-h1 font-display font-black text-text-main tracking-tight">Política de Privacidad</h1>
        </div>
        ...
        <section className="space-y-3">
          <h2 className="text-h3 font-display font-bold text-text-main">1. Responsable del Tratamiento</h2>
        ...
        <section className="space-y-3">
          <h2 className="text-h3 font-display font-bold text-text-main">2. Finalidad del Tratamiento de Datos</h2>
          <p className="text-body-reg text-text-secondary font-medium leading-relaxed">
        ...
        <section className="space-y-3">
          <h2 className="text-h3 font-display font-bold text-text-main">3. Legitimación del Tratamiento</h2>
          <p className="text-body-reg text-text-secondary font-medium leading-relaxed">
        ...
        <section className="space-y-3">
          <h2 className="text-h3 font-display font-bold text-text-main">4. Conservación de los Datos</h2>
          <p className="text-body-reg text-text-secondary font-medium leading-relaxed">
        ...
        <section className="space-y-3">
          <h2 className="text-h3 font-display font-bold text-text-main">5. Derechos del Usuario</h2>
          <p className="text-body-reg text-text-secondary font-medium leading-relaxed">
