        ...
        <section className="w-full bg-slate-50 px-4 py-10 sm:px-6 md:px-8">
          <div className="mx-auto w-full max-w-5xl">
            ...
            <h2 className="mt-2 text-h2 font-display text-text-main">
              Consulta el seguro para tu consulado de España
            </h2>
            <p className="mt-3 max-w-3xl text-body-reg text-text-secondary">
              Revisa los requisitos, precios locales y documentación específica de tu país antes de solicitar el visado.
            </p>
            <nav aria-label="Landings de seguros por país" className="mt-6 flex flex-wrap gap-3">
              {[
                ['Colombia', '/productos/seguros-salud/seguro-medico-estudiantes/colombia/'],
                ['México', '/productos/seguros-salud/seguro-medico-estudiantes/mexico/'],
                ['Argentina', '/productos/seguros-salud/seguro-medico-estudiantes/argentina/'],
                ['Chile', '/productos/seguros-salud/seguro-medico-estudiantes/chile/'],
                ['Perú', '/productos/seguros-salud/seguro-medico-estudiantes/peru/'],
                ['Ecuador', '/productos/seguros-salud/seguro-medico-estudiantes/ecuador/'],
              ].map(([label, href]) => (
                <Link
                  key={href}
                  to={href}
                ...
                >
                  Seguro para solicitantes de {label}
                </Link>
              ))}
            </nav>
          </div>
