      ...
      >
        ...
        >
          ...
          {project.preset.isCarousel && (() => {
            ...
            const slideW = project.preset.slideWidth ?? (project.preset.width / slideCount);
                ...
                {Array.from({ length: slideCount }, (_, idx) => {
                  ...
                  return (
                    <React.Fragment key={`slide-guide-${idx}`}>
                      {/* Top Header Badge */}
                      <div
                        className="absolute -top-7 flex items-center gap-1.5 rounded-t-md border-t border-x border-brand-cyan/40 bg-slate-900/90 px-2.5 py-1 backdrop-blur-xs transition-all"
                      ...
                      {idx > 0 && (
                        ...
                        >
                          <div className="absolute top-1/2 -left-3 -translate-y-1/2 rounded-full border border-brand-cyan/60 bg-slate-950 px-1.5 py-0.5 text-[8px] font-mono font-bold text-brand-cyan">
                            ✂
                          </div>
                        </div>
                      )}
                      ...
                      {showSafeZones && (
                        ...
                        >
                          ...
                          {isInstagram && isFirst && (
                            <div
                              className="absolute inset-x-0 border-2 border-dotted border-amber-400/70 bg-amber-400/[0.04]"
                              style={{
                                top: `${(project.preset.height - slideW) / 2}px`,
                                height: `${slideW}px`,
                              }}
                            >
                              <span className="absolute bottom-1 right-1 rounded bg-slate-950/80 px-1.5 py-0.5 text-[9px] font-bold text-amber-300">
                                Recorte 1:1 Cuadrícula Perfil
                              </span>
                            </div>
                          )}
