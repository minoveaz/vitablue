      ...
      if (layer.blockType === 'MotionAdvisorCard') {
        subLayers = [
          ...
          },
          {
            ...
            position: { x: layer.position.x, y: layer.position.y - 14.5 },
            zIndex: 2,
            scale: layer.scale ?? 1,
          },
          {
            ...
            position: { x: layer.position.x, y: layer.position.y - 4.5 },
            zIndex: 3,
            scale: layer.scale ?? 1,
          },
          {
        ...
        subLayers = [
          ...
          },
          {
            ...
            position: { x: layer.position.x, y: layer.position.y + 5.5 },
            zIndex: 4,
            scale: layer.scale ?? 1,
          },
          {
        ...
        subLayers = [
          ...
          },
          {
            ...
            position: { x: layer.position.x, y: layer.position.y - 10 },
            zIndex: 2,
            scale: layer.scale ?? 1,
          },
          {
            ...
            position: { x: layer.position.x, y: layer.position.y - 1.5 },
            zIndex: 3,
            scale: layer.scale ?? 1,
          },
          {
            ...
            position: { x: layer.position.x, y: layer.position.y + 8.5 },
            zIndex: 4,
            scale: layer.scale ?? 1,
          },
        ];
